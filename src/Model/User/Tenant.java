...
public class Tenant extends User {
    ...
    public Tenant(User user, String tenantID, String emergencyContact) {
        super(user.getContactNumber(), user.getFirstName(), user.getLastName(), 
              user.getPassword(), user.getUserID(), user.getUsername(), Role.TENANT);
        this.tenantID = tenantID;
        this.emergencyContact = emergencyContact;
        this.balance = 0.0;
        this.roomID = null;
